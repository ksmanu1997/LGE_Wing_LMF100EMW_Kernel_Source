...
static const unsigned char InitCodeVal[CNT_INITCODE]  = { 0x01, 0x9A, 0x01, 0x9A, 0x00, 0x21, 0x33, 0x13, 0x13, 0x13, 0x0F, 0x70, 0x82, 0x64, 0x82, 0x64, 0xC8, 0x6E, 0xD0, 0x89, 0x20, 0x10, 0x0B, 0x07, 0x0B, 0x07, 0x0B, 0x07, 0x33, 0x53, 0x6B, 0x29, 0x38, 0x53, 0x6B, 0x90, 0x4F, 0x03, 0xD7, 0x02, 0x04, 0x04 };

#elif defined (CONFIG_MACH_LAGOON_ACEXLM)
#define CNT_INITCODE					42
static const unsigned char InitCodeAddr[CNT_INITCODE] = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2A, 0x2B };
static const unsigned char InitCodeVal[CNT_INITCODE] =  { 0x11, 0x9A, 0x00, 0x11, 0x11, 0x9A, 0x33, 0x13, 0x13, 0x13, 0x0F, 0x70, 0x82, 0x64, 0x82, 0x64, 0x82, 0x64, 0xD0, 0x89, 0x20, 0x10, 0x0B, 0x07, 0x0B, 0x07, 0x0B, 0x07, 0x33, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0xCC, 0x4F, 0x03, 0x33, 0x02, 0x02, 0x04 };

#elif defined (CONFIG_MACH_LITO_WINGLM)
#define CONFIG_LITO_WINGLM_SEPERATE_INITCODE
#ifdef CONFIG_LITO_WINGLM_SEPERATE_INITCODE
#define CNT_INITCODE					42
// 2020/06/23 <Wing Register Setting Value> Threshold 10% by youngjoon.lee
static const unsigned char InitCodeAddr_WINGLM[CNT_INITCODE]           = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2A, 0x2B };
static const unsigned char InitCodeVal_WINGLM_DEFAULT[CNT_INITCODE]    = { 0x01, 0x9A, 0x00, 0x52, 0x21, 0x9A, 0x33, 0x13, 0x13, 0x13, 0x0F, 0x70, 0x82, 0x64, 0xE6, 0x64, 0x82, 0x64, 0xD0, 0x89, 0x20, 0x10, 0x0B, 0x07, 0x15, 0x0D, 0x0B, 0x07, 0x33, 0x00, 0xFF, 0x57, 0x75, 0x00, 0xFF, 0x44, 0x4F, 0x03, 0x2B, 0x02, 0x02, 0x04 };
static const unsigned char InitCodeVal_WINGLM_NA[CNT_INITCODE]         = { 0x01, 0x9A, 0x00, 0x52, 0x21, 0x9A, 0x33, 0x13, 0x13, 0x13, 0x0F, 0x70, 0x82, 0x64, 0xE6, 0x64, 0x82, 0x64, 0xD0, 0x89, 0x20, 0x10, 0x0B, 0x07, 0x15, 0x0D, 0x0B, 0x07, 0x33, 0x00, 0xFF, 0x57, 0x75, 0x00, 0xFF, 0x44, 0x4F, 0x03, 0x2B, 0x02, 0x02, 0x04 };
static const unsigned char InitCodeVal_WINGLM_GLOBAL[CNT_INITCODE]     = { 0x01, 0x9A, 0x00, 0xC9, 0x21, 0x9A, 0x33, 0x13, 0x13, 0x13, 0x0F, 0x70, 0x82, 0x64, 0xE6, 0x64, 0x82, 0x64, 0xD5, 0x89, 0x20, 0x10, 0x0B, 0x07, 0x15, 0x0D, 0x0B, 0x07, 0x33, 0x00, 0xFF, 0x57, 0x75, 0x00, 0xFF, 0x44, 0x4F, 0x03, 0x2B, 0x02, 0x02, 0x04 };
static const unsigned char* InitCodeAddr = NULL;
static const unsigned char* InitCodeVal =  NULL;
#else //CONFIG_LITO_WINGLM_SEPERATE_INITCODE
#define CNT_INITCODE					42
static const unsigned char InitCodeAddr[CNT_INITCODE]                  = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2A, 0x2B };
static const unsigned char InitCodeVal[CNT_INITCODE]                   = { 0x01, 0x9A, 0x00, 0x52, 0x01, 0x9A, 0x33, 0x13, 0x13, 0x13, 0x0F, 0x70, 0x82, 0x64, 0xE6, 0x64, 0x82, 0x64, 0xD0, 0x89, 0x20, 0x10, 0x0B, 0x07, 0x15, 0x0D, 0x0B, 0x07, 0x33, 0x50, 0x6D, 0x57, 0x75, 0x95, 0xCB, 0xFE, 0x4F, 0x03, 0x2B, 0x02, 0x02, 0x04 };
#endif //CONFIG_LITO_WINGLM_SEPERATE_INITCODE
#else // OTHERS MODEL
#define CNT_INITCODE					42
static const unsigned char InitCodeAddr[CNT_INITCODE]                  = { 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2A, 0x2B };
static const unsigned char InitCodeVal[CNT_INITCODE]                   = { 0x01, 0x9A, 0x00, 0x52, 0x01, 0x9A, 0x33, 0x13, 0x13, 0x13, 0x0F, 0x70, 0x82, 0x64, 0xE6, 0x64, 0x82, 0x64, 0xD0, 0x89, 0x20, 0x10, 0x0B, 0x07, 0x15, 0x0D, 0x0B, 0x07, 0x33, 0x50, 0x6D, 0x57, 0x75, 0x95, 0xCB, 0xFE, 0x4F, 0x03, 0x2B, 0x02, 0x02, 0x04 };
