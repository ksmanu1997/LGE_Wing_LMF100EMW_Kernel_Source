...
static ssize_t qna_meter_store(struct class *dev,
		struct class_attribute *attr,
        const char *buf,
        size_t count){
...
static ssize_t qna_safety_store(struct class *dev,
		struct class_attribute *attr,
        const char *buf,
        size_t count){
...
static ssize_t qna_vtwarn_store(struct class *dev,
		struct class_attribute *attr,
        const char *buf,
        size_t count){
...
static ssize_t qna_pcap_store(struct class *dev,
		struct class_attribute *attr,
        const char *buf,
        size_t count){
