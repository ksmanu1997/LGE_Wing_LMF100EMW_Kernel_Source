...
#define inode_inc_iversion(x)		(x->i_version++)
#define inode_peek_iversion_raw(x)	(x->i_version)
#define inode_query_iversion(x)     (x->i_version)
#define inode_set_iversion(x,y)     (x->i_version = y)
#define inode_eq_iversion(x,y)      (x->i_version == y)
#endif
